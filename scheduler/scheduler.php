...
while( true ) {
 ...
 case "jobs_without_pulse":                       // schedule cycle to check job pulses...
      ...
      mysql_query( "UPDATE job_queue SET state='queued', target_resources='any', state_time_stamp=UNIX_TIMESTAMP() WHERE state='running' AND daemon_pulse<=(UNIX_TIMESTAMP()-3600) AND lock_state=0" );
